...
\definecolor{matrixcolor}{HTML}{8A2BE2}
...
\begin{inparaitem}[\color{red}\textbullet]
  \item $\mathbf{\red{A}} \in \mathbb{R}^{N \times N}$ then $\mathbf{\red{A}} = \mathbf{\red{Q}} \red{\boldsymbol{\Lambda}} \mathbf{\red{Q}}^{-1}$ with $\mathbf{\red{Q}} \in \mathbb{R}^{N \times N}$.
  \item if all eigenvalues nonzero: $\mathbf{\red{A}}^{-1} = \mathbf{\red{Q}} \red{\boldsymbol{\Lambda}}^{-1} \mathbf{\red{Q}}^{-1}$ and $(\red{\boldsymbol{\Lambda}}^{-1})_{i,i} = \frac{1}{\lambda_i}$
  \item if $\mathbf{\red{A}}$ symmetric: $A = \mathbf{\red{Q}} \red{\boldsymbol{\Lambda}} \mathbf{\red{Q^\top}}$ (and $\mathbf{\red{Q}}$ is orthogonal).
\end{inparaitem}
...
\begin{compactenum}
	\item Empirical Mean: $\overline{\mathbf{\red{x}}} = \frac{1}{N} \sum_{n=1}^N \mathbf{\red{x}}_n$
	\item Center Data: $\overline{\mathbf{\red{X}}} = \mathbf{\red{X}} - [\overline{\mathbf{\red{x}}}, \ldots, \overline{\mathbf{\red{x}}}] = \mathbf{\red{X}} - \mathbf{\red{M}}$
	...
	\item Eigenvalue Decomposition: $\red{\boldsymbol{\Sigma}} = \mathbf{\red{U}} \red{\boldsymbol{\Lambda}} \mathbf{\red{U}}^\top$
	\item Select $K < D$, $\Rightarrow \mathbf{\red{U}}_K, \red{\boldsymbol{\lambda}}_K$
	\item Transform data onto new Basis: $\overline{\mathbf{\red{Z}}}_K = \mathbf{\red{U}}_K^\top \overline{\mathbf{\red{X}}}$
	\item Reconstruct to original Basis: $\tilde{\overline{\mathbf{\red{X}}}} = \mathbf{\red{U}}_k \overline{\mathbf{\red{Z}}}_K$
